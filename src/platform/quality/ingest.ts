...
export function applyQualityGuard(inner: RuntimeStore, deps: GuardDeps = {}): RuntimeStore {
  ...
  const guarded: RuntimeStore = {
    ...
    listFeatureStates: inner.listFeatureStates.bind(inner),
    setFeatureStates: inner.setFeatureStates.bind(inner),
    recordFeatureInterest: inner.recordFeatureInterest.bind(inner),
    listFeatureInterestCounts: inner.listFeatureInterestCounts.bind(inner),
